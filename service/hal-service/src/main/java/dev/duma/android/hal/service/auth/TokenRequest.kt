...
/**
 * Request to obtain a session token. If [serviceKey] is provided, it is verified as JWT.
 * If null, a user consent dialog is shown.
 * [requestedPermissions] optionally limits the granted permissions scope.
 * If null, all available permissions are granted (service key claims or "*" for user grant).
 */
