...
include(":plugins:printerx:plugin-sunmi-printer-lib")
include(":plugins:printerx:plugin-sunmi-drawer-lib")
include(":plugins:printerx:plugin-sunmi-lcd-lib")
include(":plugins:printerx:plugin-sunmi-printerx-bundle")
